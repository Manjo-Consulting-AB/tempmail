...
function ms_test_probe_build(string $repoRoot): string {
    ...
    foreach (['pro_profile.php', 'pro_profile_page.php', 'index.php', 'pro_auth.php', 'pro_trial.php', 'login_tokens.php', 'TwoFactorAuth.php', 'php_imap_processor.php', 'webhook_secret.php', 'paddle_sync.php', 'reserved_local_parts.php', 'email_log_ref.php'] as $page) {
